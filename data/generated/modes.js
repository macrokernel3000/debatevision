window.DEBATE_MODES = [
  ...
  },
  {
    ...
    "flow": [
      "選擇具體版或抽象版",
      "具體版固定從人生子池抽「人生」與「就像」，只抽物品或動物作為後綴",
  ...
  },
  {
    ...
    "controlRule": "先秘密選定答案，再用問題逐步縮小範圍並推理答案。",
    "cardHooks": [
      "觀察 {name} 可能透露的環境線索。",
      "設計一個能排除或確認 {name} 的問題。",
      "思考哪些提問能最快縮小到 {name}。"
    ...
    "statusRules": {
      "default": "選定任一詞庫作為秘密答案池，輸入編號後由參與者用問題推理。"
    },
    "menuLabel": "秘密 × 線索",
    "palette": "purple"
  },
  {
    ...
    "description": "輸入辯題並分別設定正反方人數，快速排出正式辯論座位黑板，再用雙方辯論計時器進行獨立計時或對辯。",
    "prompts": [],
    "flow": [
      "輸入本場辯題",
      "分別選擇正反方人數，視需要填寫姓名並標記雙方結辯",
      "確認黑板上的鏡像座位順序",
      "展開雙方辯論計時器，選擇獨立或對辯模式，使用交換與提示鈴聲開始辯論"
    ],
  ...
  },
  {
    ...
    "prompts": [
      [
        "自由組合",
        "先選幾個卡池，再挑出本場要使用的卡，並用這些卡建立一個共同題目。"
      ],
      [
        "製造規則",
